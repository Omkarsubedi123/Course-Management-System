...
public class TutorsDashBoard extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TutorsDashBoard frame = new TutorsDashBoard();
	...
	public TutorsDashBoard() {
		...
		JLabel lblNewLabel = new JLabel("Details of Teachers of College");
		lblNewLabel.setForeground(SystemColor.textHighlight);
		lblNewLabel.setFont(new Font("Arial", Font.BOLD, 25));
		lblNewLabel.setBounds(550, 10, 445, 106);
		contentPane.add(lblNewLabel);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(314, 352, 885, 200);
		...
		Tutorbutton.setBounds(314, 234, 170, 51);
