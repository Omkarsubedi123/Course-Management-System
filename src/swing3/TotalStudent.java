...
public class TotalStudent extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TotalStudent frame = new TotalStudent();
	...
	public TotalStudent() {
		...
		lblNewLabel.setBounds(624, 10, 153, 106);
		contentPane.add(lblNewLabel);
		
		JScrollPane StdTable = new JScrollPane();
		StdTable.setBounds(314, 278, 885, 226);
		...
		StdShowButton.setBounds(335, 139, 170, 51);
